...
{
    internal sealed class BoundForEachDictionaryElementStatement : BoundStatement
    {
        ...
        public BoundForEachDictionaryElementStatement(AbstractPhaseContext context, SyntaxNode node, BoundExpression iteratorSource, Symbol valueSymbol, BoundStatement bodyStatement)
            :base(node)
        {
