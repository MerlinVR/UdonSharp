...
namespace UdonSharp
{
    public static class UdonSharpUtils
    {
        ...
        private static readonly HashSet<System.Type> udonSyncTypes = new HashSet<System.Type>()
        {
            ...
            typeof(UnityEngine.Vector4),    typeof(UnityEngine.Vector4[]),
            typeof(UnityEngine.Quaternion), typeof(UnityEngine.Quaternion[]),
            typeof(UnityEngine.Color32),    typeof(UnityEngine.Color32[]),
            typeof(UnityEngine.Color),      typeof(UnityEngine.Color[]),
        };
        ...
        private static readonly HashSet<System.Type> udonLinearSyncTypes = new HashSet<System.Type>()
        {
            typeof(byte),
            typeof(sbyte),
            typeof(ushort),
        ...
        public static bool IsUdonLinearSyncType(System.Type type)
        {
            return udonLinearSyncTypes.Contains(type);
        }

        private static readonly HashSet<System.Type> udonSmoothSyncTypes = new HashSet<System.Type>()
        {
            typeof(byte),
            typeof(sbyte),
            typeof(ushort),
        ...
        public static bool IsUdonSmoothSyncType(System.Type type)
        {
            return udonSmoothSyncTypes.Contains(type);
        }
